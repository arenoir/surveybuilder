...
class SurveyResponsesControllerTest < ActionController::TestCase
  ...
  test "should create survey_response" do
    assert_difference('SurveyResponse.count') do
      post :create, survey_response: { participant_id: @survey_response.participant_id, survey_id: @survey_response.survey_id }
    end
  ...
  test "should update survey_response" do
    patch :update, id: @survey_response, survey_response: { participant_id: @survey_response.participant_id, survey_id: @survey_response.survey_id }
    assert_redirected_to survey_response_path(assigns(:survey_response))
  end
